...
class AntrianController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('antrian.add',compact('pasien'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($antrian){
            ...
            return redirect()->route('antrian.index')->with(['error' => 'Data Gagal Disimpan!']);
        }
    }
    ...
    public function cari(Request $request)
    {
        ...
        return view('antrian.show',compact('pasien'));
    }
    ...
    public function print($id)
    {
        ...
        $pdf = PDF::loadView('cetak.antrian',compact('pasien'));
